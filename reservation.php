...
<body>
  ...
  <section class="reserve-area">
    ...
    <h3>Hotel: <span>
      ...
      // This code prints out the correct hotel name the user chose, and sends that information to the next page
    ...
    <h4>Please fill out the following information to complete your booking reservation.</h4>
        ...
        <!-- After this form submits, all info is sent to next page -->
      <div class="form-group">
        ...
        <div class="form-group row">
          <div class="col-sm-10">
            ...
            <!-- This code grabs the check in, check out, and room numer, and sends it to the next page -->
