    ...
    <div class="container">
      <form action="reservation.php" method="POST" class="form">
        <div class="input-group">
          ...
          <input type="text" class="input-b" id="destination" value="<?php if(isset($_POST['state']))
                                                                            {
                                                                              echo $_POST['state']; //This code gets the selected state from the homePage and puts it in the text field
                                                                            }?>"> </input>
        </div>
        <div class="input-group">
...
<!-- This sets the page contents depending on what state is selected -->
      ...
      <div class="grid-item featured-rooms">
        ...
        <div class="room-info-wrap">
          ...
          <li>Free Cancellation
                ...
                <!-- These inputs are for sending the hotel name to the next page, depending on which button the user clicks; -->
...
<!-- If user chooses Washington -->
<?php
if(isset($_POST['state']) && $_POST['state'] == 'Washington'){?>
  <section class="rooms">
    <div class="rooms-continer">
      <h5 class="section-head">
...
<!-- If user chooses Las Vegas -->
<?php
if(isset($_POST['state']) && $_POST['state'] == 'Las Vegas'){?>
  <section class="rooms">
    <div class="rooms-continer">
      <h5 class="section-head">
